...
* **Détection comportementale (ML) :** Modèle *Isolation Forest* (Smile ML) embarqué pour évaluer le score de risque des sessions.
...
docker compose up -d
```
*La base de données sera disponible sur le port `5432` et Redis sur le port `6379`.*
